...
k1, k2, k3, k4,  g, c1, c2, t, g = symbols('k1 k2 k3 k4 g c1 c2 t g')
...
dirT11, dirT12, dirT13, dirT14 = get_wire_dir(body1=S,points_1='top', body2=B, points_2='top', suspension_body=S )
dirT21, dirT22, dirT23, dirT24 = get_wire_dir(body1=B,points_1='bottom', body2=C, points_2='top',suspension_body=S)

dirT31, dirT32, dirT33, dirT34 = get_wire_dir(body1=C,points_1='bottom', body2=D, points_2='top',suspension_body=S)
dirT41, dirT42, dirT43, dirT44 = get_wire_dir(body1=D,points_1='bottom', body2=F, points_2='top',suspension_body=S)
...
wire_sbs = [make_wire_suspy(n=3, linpath=sb_paths, index=i,
                global_frame=S.global_frame, suspension_body=S) for i in [0,1,2,3]]
wire_bcs = [make_wire_suspy(n=3, linpath=bc_paths, index=i,
                global_frame=S.global_frame, suspension_body=S) for i in [0,1,2,3]]
wire_cds = [make_wire_suspy(n=3, linpath=cd_paths, index=i,
                global_frame=S.global_frame, suspension_body=S) for i in [0,1,2,3]]
wire_dfs = [make_wire_suspy(n=3, linpath=df_paths, index=i,
                global_frame=S.global_frame, suspension_body=S) for i in [0,1,2,3]]
...
force_dict = {B:{'paths':[sb_paths, bc_paths], 'tensions':[T11, T12, T13, T14, T21, T22, T23, T24], 'points':B.points},
             C:{'paths':[bc_paths, cd_paths], 'tensions':[T21, T22, T23, T24, T31, T32, T33, T34], 'points':C.points},
             D:{'paths':[cd_paths, df_paths], 'tensions':[T31, T32, T33, T34, T41, T42, T43, T44], 'points':D.points},
             F:{'paths':[df_paths], 'tensions':[T41, T42, T43, T44], 'points':F.points}}
